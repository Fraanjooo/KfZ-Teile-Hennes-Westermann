        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="#services" className="hover:text-automotive-orange transition-colors">
                  Our Services
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-automotive-orange transition-colors">
                  Get Quote
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-automotive-orange transition-colors">
                  About Us
                </a>
              </li>
              <li>
