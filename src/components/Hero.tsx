...
const Hero = () => {
  ...
  return <section ref={ref} className="relative bg-background min-h-[600px] flex items-start justify-center text-foreground overflow-hidden pt-20">
      ...
      opacity
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          ease: "easeOut"
            ...
            <span className="hidden sm:inline">Hochwertige Ersatzteile & Autoteile für Privatkunden und Werkstätten im Münsterland.</span>
          ...
          ease: "easeOut"
            ...
            <Button variant="automotive" size="lg" onClick={scrollToContact} className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 hover:scale-105 transition-transform duration-300">
              Angebot anfordern
            </Button>
          </motion.div>
        </div>
